...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="space-y-7 animate-in fade-in duration-200" id="home-view">
      ...
      {/* 4. Section "Pasti Murah" (Horizontal swipeable cards 1-5 + 6th "Lihat Semua") - single title + subtitle, no badge */}
      <ProductScrollRow
      ...
      {/* 6. Section "Paket Unlimited & Bulanan" (Horizontal swipeable cards 1-5 + 6th "Lihat Semua") - single title + subtitle, no badge */}
      <ProductScrollRow
